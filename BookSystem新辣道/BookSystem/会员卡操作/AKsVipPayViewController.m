...
-(void)viewDidDisappear:(BOOL)animated
{
    ...
    buttonSure=nil;
    _showCardView=nil;
    _dataButtonArray=nil;
    _caozuoButtonArray=nil;
    _HUD=nil;
    _chongzhi=nil;
    _passWordView=nil;
    _passWordView2=nil;
    _checkView=nil;
    _JuanMessageArray=nil;
    _xiaofeiArray=nil;
    _FenXiaoFeiArray=nil;
    _youhuiHuChiArray=nil;
    scroll=nil;
    _kvoPrice=nil;
    queryDataFromSql=nil;
    _cardMessage=nil;
    _cardMessagelinshi=nil;
    showVip=nil;
    self.view=nil;
...
- (void)viewDidLoad
{
    ...
    for (int i=0; i<[array2 count]; i++)
    {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
    ...
    [buttonBack setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
    [buttonBack setBackgroundImage:[UIImage imageNamed:@"TableButtonYellow.png"] forState:UIControlStateHighlighted];
