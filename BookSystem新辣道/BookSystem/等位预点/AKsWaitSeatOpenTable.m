...
-(void)viewLoad1
{
    ...
    [btnConfirm setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
    ...
    [btnCancel setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
...
-(void)viewLoad2
{
    ...
    UILabel *lblPhoneNum = [[UILabel alloc] initWithFrame:CGRectMake(15, 80, 80, 30)];
    lblPhoneNum.textAlignment = UITextAlignmentRight;
    ...
    lblPeople = [[UILabel alloc] initWithFrame:CGRectMake(15, 180, 80, 30)];
    lblPeople.textAlignment = UITextAlignmentRight;
    lblPeople.backgroundColor = [UIColor clearColor];
    lblPeople.text = @"女士:";
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    else if(([string isEqualToString:@"0"] &&[textField.text length]==0)||((textField!=tfPhoenNum)&&[textField.text length]>1))
    {
        return NO;
    }
    else
