...
-(void)viewLoad1
{
    ...
    [self addSubview:lb];
    UILabel *lb1=[[UILabel alloc] initWithFrame:CGRectMake(50, 215, 60, 30)];
    lb1.text=@"提示";
    lb1.font=[UIFont fontWithName:@"ArialRoundedMTBold"size:25];
    [self addSubview:lb1];
    UIWebView *webView=[[UIWebView alloc] initWithFrame:CGRectMake(50, 250, 400, 160)];
    [self addSubview:webView];
    NSString *htmlString = [NSString stringWithContentsOfFile:[@"natice.html" documentPath] encoding:NSUTF8StringEncoding error:nil];
    [webView loadHTMLString:htmlString baseURL:[NSURL URLWithString:[@"natice.html" documentPath]]];
    webView=nil;
    btnConfirm = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    btnConfirm.frame = CGRectMake(105, 415, 100, 30);
...
//    [btnConfirm setImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
    ...
    btnCancel.frame = CGRectMake(245, 415, 100, 30);
...
-(void)viewLoad2
{
    ...
    [webView loadHTMLString:htmlString baseURL:[NSURL URLWithString:[@"natice.html" documentPath]]];
    webView=nil;
//    [webView loadHTMLString:htmlString baseURL:[NSURL URLWithString:[@"notice.html" documentPath]]];
    btnConfirm = [UIButton buttonWithType:UIButtonTypeCustom];
    btnConfirm.frame = CGRectMake(240, 415, 90, 40);
    ...
    btnCancel.frame = CGRectMake(345, 415, 90, 40);
