...
- (id)initWithFrame:(CGRect)frame withTag:(int)tag{
    ...
    if (self) {
        ...
        [btnChunk setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
        if (tag==1) {
        ...
        else
        {
            ...
            _lblcount.textAlignment = UITextAlignmentRight;
            _lblcount.text=@"赠送数量";
            ...
            _lblfan.textAlignment = UITextAlignmentRight;
            _lblfan.text=@"取消赠送";
...
//    CVLocalizationSetting *langSetting = [CVLocalizationSetting sharedInstance];
    ...
    if (bAuth){
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"请确认是否有没有填写的信息"
                                                        message:nil
                                                       delegate:nil
